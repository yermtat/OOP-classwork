...
int main() {
	...
	//род класс принтер, основной метод принт (должен уметь печатать, должен принимать какой-то текст, показывать им€ принтера, напечатавшего текст
	// должен быть указан тип принтера 
	// должна быть фукци€ котора€ принимает принтер и по-разному принтовать
